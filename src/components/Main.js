  ...
  return (
      <div ref={props.setWrapperRef} id="main" style={props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="intro" className={`${props.article === 'intro' ? 'active' : ''} ${props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>Basic Instructions Books While On Earth, Creation Of All <a href="https://bibwoe.com/posts/creation-of-all" rel="noopener noreferrer" target="_blank" area-label="Bibwoe">Bibwoe.com</a>.</p>
        ...
        <article id="contact" className={`${props.article === 'contact' ? 'active' : ''} ${props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <ul className="icons">
            <li>
              <a href="https://twitter.com/donboulton" className="icon" rel="noopener noreferrer" target="_blank" area-label="Twitter">
            ...
            <li>
              <a href="https://facebook.com/donboulton" className="icon" rel="noopener noreferrer" target="_blank" area-label="Facebook">
            ...
            <li>
              <a href="https://www.instagram.com/boulton3662/" className="icon" rel="noopener noreferrer" target="_blank" area-label="Instagram">
            ...
            <li>
              <a href="https://github.com/donaldboulton/donboulton.com" className="icon" rel="noopener noreferrer" target="_blank" area-label="Github">
            ...
            <li>
              <a href="https://youtube.com/users/donaldboulton/" className="icon" rel="noopener noreferrer" target="_blank" area-label="Youtube">
